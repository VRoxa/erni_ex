...
public class UserNotFoundMiddlewareTests
{
    [Fact]
    public async Task OnInvoke_IfRequestDoesNotThrowException_Continues()
    {
        ...
        var sut = new UserNotFoundMiddleware(requestDelegate);
    ...
    {
        var exception = new UserNotFoundException("Invalid request", new Exception("Inner message"));
